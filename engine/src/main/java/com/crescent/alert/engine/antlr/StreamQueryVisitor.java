...
public interface StreamQueryVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link StreamQuery#columList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColumList(StreamQuery.ColumListContext ctx);
	/**
	 * Visit a parse tree produced by {@link StreamQuery#nameOprand}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNameOprand(StreamQuery.NameOprandContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code DynaBLExpr}
	 * labeled alternative in {@link StreamQuery#name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDynaBLExpr(StreamQuery.DynaBLExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link StreamQuery#whereCluaster}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhereCluaster(StreamQuery.WhereCluasterContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link StreamQuery#duration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDuration(StreamQuery.DurationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code MoMParams}
	 * labeled alternative in {@link StreamQuery#dynaBaseLineConfig}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMoMParams(StreamQuery.MoMParamsContext ctx);
	/**
	 * Visit a parse tree produced by the {@code AnomListSizeParams}
	 * labeled alternative in {@link StreamQuery#dynaBaseLineConfig}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnomListSizeParams(StreamQuery.AnomListSizeParamsContext ctx);
}